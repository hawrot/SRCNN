...
class SRCNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=None, out_channels=None, kernel_size=None, padding=None)
        self.conv2 = nn.Conv2d(in_channels=None, out_channels=None, kernel_size=None, padding=None)
        self.conv3 = nn.Conv2d(in_channels=None, out_channels=None, kernel_size=None, padding=None)
